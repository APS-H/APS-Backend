 ...
 * 
 */
@WebServiceClient(name = "OrderServiceService", targetNamespace = "http://service.legacy.apsh.com/", wsdlLocation = "http://81.69.252.233:9001/order?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICESERVICE_QNAME = new QName("http://service.legacy.apsh.com/", "OrderServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://81.69.252.233:9001/order?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://service.legacy.apsh.com/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.legacy.apsh.com/", "OrderServicePort"), OrderService.class, features);
    }
